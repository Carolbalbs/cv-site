...
A modern, responsive Hugo theme for personal websites and portfolios, created by Ana Carolina Balbino. This theme is designed to showcase your professional experience, skills, and projects in a clean and elegant way, with a focus on engineering and technical portfolios.
...
See the theme in action at [felipecordero.com](https://carolbalbs.com) - my personal website built with CareerCanvas.

![CareerCanvas Demo](https://raw.githubusercontent.com/carolbalbs/carolbalbs.github.io/main/static/images/personal_web_demo.png)
...
```bash
git submodule add https://github.com/carolbalbs/careercanvas.git themes/careercanvas
```

### As a Git Clone

```bash
git clone https://github.com/carolbalbs/careercanvas.git themes/careercanvas
```
...
- [CareerCanvas](https://github.com/carolbalbs/careercanvas) - Custom Hugo theme
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/carolbalbs/careercanvas/issues).

## 📫 Contact

For any questions or suggestions, please open an issue in the GitHub repository or visit [felipecordero.com](https://carolbalbs.com).
